      ...
      child: RaisedButton(
        ...
        onPressed: () async {
          ...
          setState(() => isLoading = true);
            ...
            if (widget.isEdit) {
            DocumentReference documentTask = firestore.collection('users').doc('${widget.uid}/tasks/${widget.documentId}');
          ...
          CollectionReference tasks = firestore.collection('users').doc(widget.uid).collection('tasks');
